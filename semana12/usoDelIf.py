...
dia = input("Seleccione el dia de la semana ")
...
#Crear una funcion que valide que el nombre es mayucula

nom = input("ingrese su nombre: ")
if nom.isupper():
    print("El nombre es mayuscula")
else: print ("El nombre no es mayusculas")
